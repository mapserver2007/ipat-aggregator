...
func NewAnalysis(logger *logrus.Logger) *controller.Analysis {
	...
	placeUnHit := analysis_service.NewPlaceUnHit(horseRepository, raceForecastRepository, spreadSheetRepository, horseEntityConverter, analysisFilter, placeCheckList)
