...
func NewMaster() *controller.Master {
	...
	master := master_usecase.NewMaster(ticket, raceId, race, jockey, winOdds, placeOdds, trioOdds, analysisMarker, predictionMarker)
