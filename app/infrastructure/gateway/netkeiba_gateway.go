...
type NetKeibaGateway interface {
	...
	FetchRacingNumber(ctx context.Context, url string) ([]*netkeiba_entity.RacingNumber, error)
	FetchJockey(ctx context.Context, url string) (*netkeiba_entity.Jockey, error)
	FetchOdds(ctx context.Context, url string) ([]*netkeiba_entity.Odds, error)
}
...
func (n *netKeibaGateway) FetchRacingNumber(
	ctx context.Context,
	url string,
) ([]*netkeiba_entity.RacingNumber, error) {
	var racingNumbers []*netkeiba_entity.RacingNumber
	n.client.OnHTML(".RaceList_DataList", func(e *colly.HTMLElement) {
	...
	log.Println(ctx, fmt.Sprintf("fetching racing number from %s", url))
...
func (n *netKeibaGateway) FetchOdds(
	ctx context.Context,
	url string,
) ([]*netkeiba_entity.Odds, error) {
	log.Println(ctx, fmt.Sprintf("fetching odds from %s", url))
