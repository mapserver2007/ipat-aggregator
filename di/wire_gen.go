...
var AnalysisSet = wire.NewSet(analysis_usecase.NewAnalysis, analysis_service.NewPlace, analysis_service.NewTrio, analysis_service.NewPlaceAllIn, analysis_service.NewPlaceUnHit, analysis_service.NewPlaceCheckList, analysis_service.NewBetaWin, master_service.NewHorse, master_service.NewRaceForecast, filter_service.NewAnalysisFilter, infrastructure.NewHorseRepository, infrastructure.NewRaceForecastRepository, infrastructure.NewSpreadSheetRepository, gateway.NewNetKeibaGateway, gateway.NewNetKeibaCollector, gateway.NewTospoGateway, file_gateway.NewPathOptimizer, converter.NewHorseEntityConverter, converter.NewRaceForecastEntityConverter)
